<html>
  <div class="background">
    <h1>v3.6.1 (2025/10/03)</h1>
    <li>Minor bug fix</li>
  </div>
  <div class="background">
    <h1>v3.6.0 (2025/10/03)</h1>
    <li>Added FSRS info (Difficulty, Stability, and Retrievability stats) to the card info sidebar (Issue #88)</li>
    <li>Removed the CTRL+A shortcut due to it interfering with default anki shortcuts (Issue #90)</li>
    <li>Fixed tooltip positioning for default and custom sizes (Issue #98)</li>
    <li>Added a feature where you can choose the tooltip size (only for fixed position button tooltip style)</li>
    <li>Changed getting anki version so it's compatible with Anki beta versions too (Issue #99)</li>
    <li>Finished and refined suspend method for skipping cards</li>
  </div>
  <div class="background">
